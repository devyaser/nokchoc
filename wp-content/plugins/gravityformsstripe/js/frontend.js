...
class StripePaymentsHandler {
  ...
  */
	async validate(event) {
		...
		const is_valid_submission = 'data' in response && 'is_valid' in response.data && response.data.is_valid && 'resume_token' in response.data && 'intent' in response.data && 'client_secret' in response.data.intent;
